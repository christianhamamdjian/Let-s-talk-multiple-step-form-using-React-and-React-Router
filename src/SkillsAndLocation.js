...
class SkillsAndLocation extends Component {
	constructor(props) {
        ...
        handleOtherDisciplines = e => {
            ...
            index === -1
                ? this.setState(prevState => ({ otherDisciplines: [...prevState.otherDisciplines, value] }))
                : this.setState(prevState => {
                        return {
                            otherDisciplines: [
...
<div className="skills-left">
        ...
        <label htmlFor="other-front-end-development">Front-end Development</label>
        <input 
            ...
            onChange={this.handleOtherDisciplines}
            checked={otherDisciplines.includes('other-front-end-development')}
        />
        ...
        <span>You must be legally authorized to work without visa sponsorship in the location you choose.</span>
        ...
        />
          ...
          <button className="submit-button" type="submit" title="submit" value="submit" disabled={this.isSubmitDisabled(errors)}>Go to Portfolio page</button>
